...
#
# Author: Emily Purcell (ep198@duke.edu)
# Date:   Fall 2023
#--------------------------------------------------------------
...
# Initiailze dictionaries
date_dict = {}
location_dict = {} 

#For loop - Pretend we read one line of data from the file 
for lineString in line_list:
    ...
    #Determine if location criteria is met
    if obs_lc in ("1","2","3"):
